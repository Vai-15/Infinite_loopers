export default function SecurityBadge({ compact = false }) {
  const checks = ["Reentrancy Guards", "Rate Limiting", "Input Validation", "CORS Enabled"];
  ...
  return (
    ...
    >
      <h3 className="mb-3 text-sm font-bold uppercase tracking-wider text-emerald-200">Security Layer</h3>
